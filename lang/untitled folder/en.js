export default {
  ...
  about_section_p3_desktop: `Our mission is to build a future for Africans by empow-ering the African startup ecosystem.`,
  ...
  subtext_1: `Bantaba is Africa’s biggest startup-diaspora community that connects African tech startups to investors, mentors and consultants in the African diaspora.`,
  subtext_2: `Our platform enables the African diaspora to contribute to Africa’s tech ecosystem through networking, mentoring and investing in tech startups on the continent.`,
  desire_build_africa: `A desire to build Africa`,
  subtext_1: `The company was founded in 2021 by a group of young diaspora professionals who saw the potential of using Africa’s magnitude of resources in the diaspora to build the continent.`,
  subtext_2: ` Working together we built Bantaba, a startup-diaspora community where African tech startups can access knowledge, network and capital and diaspora professionals can contribute to the development of Africa by supporting entrepreneurs addressing important challenges on the continent.`,
  we_empowring_startups: `We’re empowering startups and bringing Africa closer to the Diaspora.`,
  subtext_1:`As a diaspora professional, our platform uses your preference to connect you with startups that perfectly match your interest, think Tinder but for a different kind of love - LOVE FOR AFRICA. `,
  subtext_2: `African tech startups, on the other hand, can share their funding and knowledge needs, and get matched with diaspora investors or professionals in the community who can help reach their goals.`,
  bantaba_is_on_mission:`Bantaba is on a mission to become the link between global knowledge, capital and Africa's startup ecosystem. `,
  it_time_for_africa: `It's TIME FOR AFRICA, we start the revolution together!`,
  our_team:`Our Team`,
  ...
  ans_32:'We built Bantaba with the security of your personal information in mind. All user data are encrypted and securely stored. Our platform is compliant with the EU’s General Data Protection Regulation (GDPR), which is the toughest privacy and security law in the world. <Learn more about our privacy policies.>',
