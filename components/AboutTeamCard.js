...
const TeamContainer = styled.li`
  ...
  .s-links{
    ...
    /* height: 30px; */
    padding: 5px;
    background: linear-gradient(108.42deg, rgba(192, 250, 218, 0.1) 5.46%, rgba(71, 232, 143, 0.025) 80.51%);
...
`;
const AboutTeamCard = ({ src, name, position, social }) => {
  return (
    <TeamContainer>
      <div className='left'>
        <Fade bottom>
